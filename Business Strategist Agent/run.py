...
TASKS: dict[str, dict] = {
    "competitor-track": {
        "script": os.path.join(_AGENT_DIR, ".agents", "skills", "competitive-intelligence",
                               "execution", "competitor_tracker.py"),
        "description": "Track and analyze competitors in the prop firm space",
    },
    "growth-model": {
        "script": os.path.join(_AGENT_DIR, ".agents", "skills", "growth-strategy",
                               "execution", "growth_model.py"),
        "description": "Run growth forecasting models and scenario analysis",
    },
    "retention-analyze": {
        "script": os.path.join(_AGENT_DIR, ".agents", "skills", "growth-strategy",
                               "execution", "retention_analyzer.py"),
        "description": "Analyze user retention, churn cohorts, and LTV",
    },
    "partnership-eval": {
        "script": os.path.join(_AGENT_DIR, ".agents", "skills", "partnership-strategy",
                               "execution", "partnership_evaluator.py"),
        "description": "Evaluate and score potential IB/partnership opportunities",
    },
    "scrape-ib-pdfs": {
        "script": os.path.join(_AGENT_DIR, ".agents", "skills", "partnership-strategy",
                               "execution", "scrape_ib_pdfs.py"),
        "description": "Scrape and parse IB agreement PDFs for terms extraction",
    },
    "market-sizing": {
        "script": os.path.join(_AGENT_DIR, ".agents", "skills", "prop-firm-market-research",
                               "execution", "market_sizing_calculator.py"),
        "description": "Calculate TAM/SAM/SOM for prop firm market segments",
    },
    "market-scrape": {
        "script": os.path.join(_AGENT_DIR, ".agents", "skills", "prop-firm-market-research",
                               "execution", "market_research_scraper.py"),
        "description": "Scrape prop firm market data and pricing intelligence",
    },
    "pricing-optimize": {
        "script": os.path.join(_AGENT_DIR, ".agents", "skills", "revenue-optimization",
                               "execution", "pricing_optimizer.py"),
        "description": "Optimize pricing tiers and analyze price sensitivity",
    },
    "ib-revenue": {
        "script": os.path.join(_AGENT_DIR, ".agents", "skills", "revenue-optimization",
                               "execution", "ib_revenue_model.py"),
        "description": "Model IB revenue projections and commission structures",
    },
    "scorecard": {
        "script": os.path.join(_AGENT_DIR, ".agents", "skills", "strategic-planning",
                               "execution", "strategic_scorecard.py"),
