...
TASKS: dict[str, dict] = {
    "campaign-track": {
        "script": os.path.join(_AGENT_DIR, ".agents", "skills", "ad-campaigns",
                               "execution", "campaign_tracker.py"),
        "description": "Track ad campaign performance, spend, and ROI",
    },
    "email-sequences": {
        "script": os.path.join(_AGENT_DIR, ".agents", "skills", "email-marketing",
                               "execution", "email_sequence_manager.py"),
        "description": "Manage email sequences — create, schedule, analyze",
    },
    "waitlist-nurture": {
        "script": os.path.join(_WORKSPACE, "shared", "email_nurture.py"),
        "description": "Process new waitlist signups → Resend welcome + drip emails",
    },
    "seo-track": {
        "script": os.path.join(_AGENT_DIR, ".agents", "skills", "seo-strategy",
                               "execution", "seo_tracker.py"),
        "description": "Track keyword rankings, site audits, and SEO metrics",
    },
    "landing-page": {
        "script": os.path.join(_AGENT_DIR, ".agents", "skills", "landing-page-optimization",
                               "execution", "landing_page_optimizer.py"),
        "description": "Manage landing page A/B tests and conversion optimization",
    },
    "lead-gen": {
        "script": os.path.join(_AGENT_DIR, ".agents", "skills", "lead-generation",
                               "execution", "lead_generator.py"),
        "description": "Ingest, score, segment, and route leads from all channels",
    },
    "newsletter": {
        "script": os.path.join(_AGENT_DIR, ".agents", "skills", "newsletter-management",
                               "execution", "newsletter_manager.py"),
